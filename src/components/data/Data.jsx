...
export const footerContact = [
  {
    ...
    name: "123 Nyali, Mombasa, Kenya",
  },
  {
    icon: <i className="fa fa-phone-alt me-3"></i>,
    name: "+25470 345 67890",
  },
  {
...
export const testimonial = [
  {
    description:
      "I enjoyed the pool, gym, yoga, and spa. The boat tours, surfing and diving were fantastic",
    name: "Client Name",
...
export const roomItems = [
  {
    ...
    description:
      "Single master bed, 1 full bath and Massage",
...

  {
    ...
    description:
      "Double master bed, 2 full bath and Massage",
    yellowbtn: "View Detail",
    darkbtn: "book now",
  },
  {
    img: "../assets/img/room-3.jpg",
    price: "Kshs. 15,000/night",
    name: "Super Deluxe",
    star: [
      <small class="fa fa-star text-primary"></small>,
      <small class="fa fa-star text-primary"></small>,
    ...
    description:
      "3 master beds, 3 full bath and Massage",
    yellowbtn: "View Detail",
    darkbtn: "book now",
  },
];
